...
It is rare that you will want to call WithError(), as Error() and Errorf()
handle this for you.
...
errors are not inspected for causes. This is because when called in this way,
...
3. Install the echo logger When using echo; this lives in the
   `apiutil/echologger` package:
